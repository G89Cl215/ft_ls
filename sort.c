...
/*   Updated: 2019/03/03 18:23:35 by tgouedar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_sortrev_ascii(t_flist **lst_start, t_flist *to_sort)
{
	char	*name_sort;
	char	*name_cur;
	t_flist	*voyager;
...
void		ft_sortins_ascii(t_flist **lst_bot, t_flist *to_sort)
{
	char	*name_sort;
	char	*name_cur;
	t_flist	*voyager;
...
void		ft_sort_ascii_in_time(t_flist **voyager, t_flist *to_sort, int flag)
{
	struct stat		sb_sort;
	struct stat		sb;
...
/*void		ft_parse_sort_time(t_flist **lst_start, t_flist *to_sort, int flag)
{
	struct stat		sb_sort;
	struct stat		sb;
	t_flist			*voyager;
...
void		ft_sortins(t_flist *new_nod, t_flist **dir_end, t_options option)
{
